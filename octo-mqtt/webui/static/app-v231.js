...
// Version 2.3.1 - Fixed BLE proxy API response handling - ULTIMATE CACHE BUST
document.addEventListener('DOMContentLoaded', () => {
    console.log('🔧 Octo MQTT v2.3.1 - BLE Proxy API Fix Applied - ULTIMATE CACHE BUST LOADED!');
    console.log('✅ JavaScript file: app-v231.js loaded successfully');
